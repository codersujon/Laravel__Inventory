        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('logo') }}/inventory-logo.png" alt="logo-sm" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('logo') }}/inventory-logo-light.png" alt="logo-dark" height="45">
                    </span>
                </a>

                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('logo') }}/inventory-logo.png" alt="logo-sm-light" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('logo') }}/inventory-logo-light.png" alt="logo-light" height="45">
                    </span>
                </a>
            </div>
