                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('supplier.destroy', $item->id) }}" id="delete" class="btn btn-danger btn-sm waves-effect waves-light"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('supplier.add') }}" method="POST" id="Supplier_Form">
                                                    @csrf
                                                    {{-- Supplier Name --}}
                                                    <div class="row mb-1">
                                ...
                                <!-- Update Supplier Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('supplier.update', $item->id) }}" method="POST" id="Supplier_Form">
                                                    @csrf
                                                    {{-- Supplier Name --}}
                                                    <div class="row mb-1">
                                                        <label for="supplier_name" class="col-form-label">Supplier Name</label>
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" value="{{ $item->name }}" id="supplier_name"
                                                                name="supplier_name">
                                                        </div>
                                                    </div>
                                                    {{-- Mobile No --}}
                                                    <div class="row mb-1">
                                                        <label for="mobile_no" class="col-form-label">Mobile No</label>
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="number" value="{{ $item->mobile_no }}" id="mobile_no"
                                                                name="mobile_no">
                                                        </div>
                                                    </div>
                                                    {{-- Email --}}
